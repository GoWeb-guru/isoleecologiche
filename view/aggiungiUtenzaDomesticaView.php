  ...
  <div class="tm-middle uk-grid">
    ...
    <div class="registration">      
      <div class="page-header">
        ...
        <h2>Nuova Utenza Domestica</h2>
		<span style="font-size: smaller;"> (* = Campo Obbligatorio) <span>
      </div>
      
      
      <form id="register" action="ctrl/aggiungiUtenzaDomesticaCtrl.php" method="post" class="form-validate form-horizontal well">
        ...
        <div class="control-group">
          <div class="control-label">
            <label id="jform_name-lbl" for="jform_name" class="hasTooltip required">
              Cognome e nome:<span class="star">&nbsp;*</span>
            </label>
          </div>
          <div class="controls">
          ...
          indirizzo: "required",
				...
				if ($.validator) {
					$('#register').validate({
						...
						messages: {
							codiceFiscale: {
								regex: "Inserire un codice fiscale"
							},
							telefono: {
