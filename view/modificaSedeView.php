...
<div class="profile">    
      ...
      <form id="register" action="ctrl/modificaSedeCtrl.php" method="post" class="form-validate form-horizontal well">
	    <input  type="hidden" name="idSede" value="<?=output($sede->idSede)?>"/>
	  
		<fieldset id="users-profile-core">

		<?php if ($idTipologiaUtente==1) {?>
			<legend>Modifica dati sede principale</legend>
		<?php }?>	
		<?php if ($idTipologiaUtente==2) {?>
			<legend>Modifica dati sede utenza</legend>
		<?php }?>
